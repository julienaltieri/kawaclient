...
| [`stream-prediction-v2.md`](stream-prediction-v2.md) | The v2 stream model, as a decomposition into six sub-problems. A specification under review — nothing built, no solutions, and not wired to the balance until the exit criteria are met. |
