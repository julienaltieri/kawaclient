...
| [`money-flow.md`](money-flow.md) | Page two of that carousel: where the money came from and where it went, as one navigable picture — the data contract behind it, the layout and camera rules, and the two instruments it was built with. |
