...
| [`Spec - stream prediction.md`](<../src/processors/streamPredictor/Spec - stream prediction.md>) | The v2 stream model, as a decomposition into six sub-problems. A specification under review — nothing built, no solutions, and not wired to the balance until the exit criteria are met. |
